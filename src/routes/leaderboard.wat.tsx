...
export const Route = createFileRoute("/leaderboard/wat")({
  head: () => ({
    meta: [
      { title: "WAT Leaderboard — ForgeSSB" },
      { name: "description", content: "Top WAT scores from ForgeSSB full simulations." },
      { name: "robots", content: "noindex" },
    ],
  }),
  component: WatLeaderboardPage,
});

function WatLeaderboardPage() {
  ...
  return (
    <section className="mx-auto max-w-5xl px-4 py-12 sm:px-6 sm:py-16">
      ...
      {/* Table */}
      <div className="mt-4">
        <LeaderboardTable testType="wat" timeFilter={timeFilter} user={user} />
      </div>
